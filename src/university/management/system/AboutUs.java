...
public class AboutUs extends JFrame {
	...
	public AboutUs() {
		...
		super("About Us - University Of Engineering And Management Kolkata");
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/uem.png"));
		...
		JLabel l6 = new JLabel("Developed By : Shubham Dutta");
		l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
		l6.setBounds(70, 198, 600, 35);
		contentPane.add(l6);

		JLabel l7 = new JLabel("Roll Number - 58");
		l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		l7.setBounds(70, 260, 600, 34);
		contentPane.add(l7);

		JLabel l8 = new JLabel("Contact : shubhamduttanovember@gmail.com");
		...
		JLabel l10 = new JLabel("Phone - +91 9330715811");
